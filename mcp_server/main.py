...
from models import (
    ...
    CreateVaultOutput,
    DescribeVaultOutput,
    FieldAccountIdPoliciesDataRetrievalPutRequest,
    FieldAccountIdVaultsVaultNameAccessPolicyPutRequest,
    FieldAccountIdVaultsVaultNameArchivesPostRequest,
    FieldAccountIdVaultsVaultNameJobsPostRequest,
    FieldAccountIdVaultsVaultNameLockPolicyPostRequest,
    FieldAccountIdVaultsVaultNameMultipartUploadsUploadIdPutRequest,
    FieldAccountIdVaultsVaultNameNotificationConfigurationPutRequest,
    FieldAccountIdVaultsVaultNameTagsOperationAddPostRequest,
    FieldAccountIdVaultsVaultNameTagsOperationRemovePostRequest,
...
def set_data_retrieval_policy(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdPoliciesDataRetrievalPutRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def delete_vault(
    account_id: str = Path(..., alias='accountId'),
    vault_name: str = Path(..., alias='vaultName'),
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    x__amz__credential: Optional[str] = Header(None, alias='X-Amz-Credential'),
...
@app.get(
    ...
    tags=['vault_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
...
@app.delete(
    ...
    description=""" <p>This operation deletes the access policy associated with the specified vault. The operation is eventually consistent; that is, it might take some time for Amazon S3 Glacier to completely remove the access policy, and you might still see the effect of the policy for a short time after you send the delete request.</p> <p>This operation is idempotent. You can invoke delete multiple times, even if there is no policy associated with the vault. For more information about vault access policies, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/vault-access-policy.html">Amazon Glacier Access Control with Vault Access Policies</a>. </p> """,
    tags=['vault_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
def set_vault_access_policy(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameAccessPolicyPutRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['archive_operations', 'vault_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def upload_archive(
    vault_name: str = Path(..., alias='vaultName'),
    account_id: str = Path(..., alias='accountId'),
    x_amz_archive_description: Optional[str] = Header(
        None, alias='x-amz-archive-description'
    ),
    x_amz_sha256_tree_hash: Optional[str] = Header(
        None, alias='x-amz-sha256-tree-hash'
    ),
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameArchivesPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    ...
    tags=['archive_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def delete_archive(
    account_id: str = Path(..., alias='accountId'),
    vault_name: str = Path(..., alias='vaultName'),
    archive_id: str = Path(..., alias='archiveId'),
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    x__amz__credential: Optional[str] = Header(None, alias='X-Amz-Credential'),
...
@app.post(
    ...
    tags=['job_control', 'vault_operations'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def initiate_job(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameJobsPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def initiate_vault_lock(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameLockPolicyPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.post(
    ...
    tags=['archive_operations', 'multipart_upload_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def initiate_multipart_upload(
    ...
    x_amz_part_size: Optional[str] = Header(None, alias='x-amz-part-size'),
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
    x__amz__date: Optional[str] = Header(None, alias='X-Amz-Date'),
    x__amz__algorithm: Optional[str] = Header(None, alias='X-Amz-Algorithm'),
    x__amz__credential: Optional[str] = Header(None, alias='X-Amz-Credential'),
...
def complete_multipart_upload(
    ...
    vault_name: str = Path(..., alias='vaultName'),
    upload_id: str = Path(..., alias='uploadId'),
    x_amz_archive_size: Optional[str] = Header(None, alias='x-amz-archive-size'),
    x_amz_sha256_tree_hash: Optional[str] = Header(
        None, alias='x-amz-sha256-tree-hash'
    ),
    x__amz__content__sha256: Optional[str] = Header(None, alias='X-Amz-Content-Sha256'),
...
def upload_multipart_part(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameMultipartUploadsUploadIdPutRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.delete(
    ...
    description=""" <p>This operation deletes the notification configuration set for a vault. The operation is eventually consistent; that is, it might take some time for Amazon S3 Glacier to completely disable the notifications and you might still receive some notifications for a short time after you send the delete request.</p> <p>An AWS account has full permission to perform all operations (actions). However, AWS Identity and Access Management (IAM) users don't have any permissions by default. You must grant them explicit permission to perform specific actions. For more information, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/using-iam-with-amazon-glacier.html">Access Control Using AWS Identity and Access Management (IAM)</a>.</p> <p> For conceptual information and underlying REST API, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/configuring-notifications.html">Configuring Vault Notifications in Amazon S3 Glacier</a> and <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/api-vault-notifications-delete.html">Delete Vault Notification Configuration </a> in the Amazon S3 Glacier Developer Guide. </p> """,
    tags=['vault_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.put(
    ...
    tags=['vault_notification_configuration'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def set_vault_notifications(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameNotificationConfigurationPutRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
@app.get(
    ...
    description=""" This operation lists all the tags attached to a vault. The operation returns an empty map if there are no tags. For more information about tags, see <a href="https://docs.aws.amazon.com/amazonglacier/latest/dev/tagging.html">Tagging Amazon S3 Glacier Resources</a>. """,
    tags=['vault_operations', 'vault_access_control'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
...
@app.post(
    ...
    tags=['vault_operations', 'vault_access_control', 'vault_tagging_management'],
    security=[
        APIKeyHeader(name="Authorization"),
    ],
)
def add_tags_to_vault(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameTagsOperationAddPostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
...
def remove_tags_from_vault(
    ...
    x__amz__signature: Optional[str] = Header(None, alias='X-Amz-Signature'),
    x__amz__signed_headers: Optional[str] = Header(None, alias='X-Amz-SignedHeaders'),
    body: FieldAccountIdVaultsVaultNameTagsOperationRemovePostRequest = ...,
):
    raise RuntimeError("Should be patched by MCPProxy and never executed")
